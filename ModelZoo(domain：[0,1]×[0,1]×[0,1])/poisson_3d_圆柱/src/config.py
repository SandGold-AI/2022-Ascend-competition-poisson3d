...
class Options_poisson(object):
    def __init__(self):
        ...
        parser.add_argument('--n_x', type=int, default=31, help='number of interior point samples on the X-axis')
        parser.add_argument('--n_y', type=int, default=31, help='number of interior point samples on the Y-axis')
        parser.add_argument('--n_z', type=int, default=31, help='number of interior point samples on the Z-axis')
